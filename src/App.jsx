...
export default function App() {
  ...
  const getStepComponent = () => {
    switch (step) {
      case 1:
        return <Step1Name {...props} />;
      case 2:
        return <Step2Phone {...props} />;
      case 3:
        return <Step3Household {...props} />;
      case 4:
        return <Step4ColdPressed {...props} />;
      case 5:
        return <Step5CurrentOils {...props} />;
      case 6:
        return <Step6Recommendation {...props} />;
      default:
        return <Step1Name {...props} />;
    }
  };
  ...
  return (
    <div className="flex flex-col min-h-screen bg-gray-50">
      {/* Full-width Shopify-style header */}
      <Header />
