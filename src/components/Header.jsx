...
export default function Header({ cartCount = 0 }) {
  return (
    <header className="w-full bg-white fixed top-0 left-0 z-20 shadow-sm">
      <div className="w-full max-w-screen-xl mx-auto flex items-center justify-between px-4 py-3">
        {/* Hamburger */}
        <button aria-label="Menu" className="p-2 bg-[#121826] rounded-lg">
          <svg
        ...
        <div className="flex items-center space-x-4">
          <button aria-label="Search" className="p-2 bg-[#121826] rounded-lg">
            <svg
              className="w-6 h-6 text-white"
              fill="none"
              stroke="currentColor"
          ...
          <button aria-label="Cart" className="relative p-2 bg-[#121826] rounded-lg">
            <svg
              className="w-6 h-6 text-white"
              fill="none"
              stroke="currentColor"
